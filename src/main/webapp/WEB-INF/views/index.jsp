...
<div id="fh5co-offcanvas">
    ...
    <div class="fh5co-bio">
        ...
        <h2>Mustafa Sabit SİPAHİ</h2>
        <p>Bilgisayar Mühendisiyim. Web ve Mobil uygulama geliştirmekteyim.</p>
        <ul class="fh5co-social">
            <li><a href="#"><i class="icon-twitter">Ayarlar</i></a></li>
        </ul>
    </div>
...
<header id="fh5co-header">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <ul class="fh5co-social">
                <li><a href="ekle"><i class="icon-file"></i>Not Ekle</a></li>
            </ul>
            <div class="col-lg-12 col-md-12 text-center">
                <h1 id="fh5co-logo"><a href="index">${merhaba}</a></h1>
            </div>
...
<div class="container-fluid">
    <div class="row fh5co-post-entry">
        <article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
            <span class="fh5co-meta"><a href="detail">Teknoloji</a></span>
            <h2 class="fh5co-article-title"><a href="detail">Blog Başlığı</a></h2>
